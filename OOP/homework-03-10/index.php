...
$color = new Color(127, 0, 0);//создаем цвет для 1-го прямоугольника
$rect = new Rectangle($color, 100, 50);//создаем 1-й прямоугольник заданного цвета и размеров
$rect->render();//выводим 1-й прямоугольник
...
$bordRec->render();//выводим 2-й прямоугольник
